 ...
 * @author David
 */
public class Response_SRT implements Serializable, JSonable{
    ...
    public Response_SRT (String codigo, String descripccion, String ticket){
    this.codigo = codigo;
   ...
   @Override
    ...
    public Object fromJSON(String message) {
        Gson gson = new GsonBuilder().setDateFormat("yyyy-MM-dd").create();
        return gson.fromJson(message, Response_SRT.class);
    }
